...
var startSynth = function(){
  ...
  synth = new Tone.MonoSynth({"detune":25, "filterEnvelope":{
  "attack":0, "decay":0, "sustain":0, "release":0, "baseFrequency":200}
  }).toMaster();

  synth2 = new Tone.MonoSynth({"detune":25, "filterEnvelope":{
  "attack":0, "decay":0, "sustain":0, "release":0, "baseFrequency":200}
  }).toMaster();
